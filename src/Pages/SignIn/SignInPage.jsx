...
function AuthProvider({ children }) {
  ...
  const authenticate = (username, password) => {
    ...
    if (username === dummyUsername && password === dummyPassword) {
      ...
      setError("User Doesnot exist"); // Set error message
    }
  };

  return (
    <AuthContext.Provider value={{ authenticated, authenticate, error }}>
      {children}
...
function SignInForm() {
  const { authenticate, error } = React.useContext(AuthContext);

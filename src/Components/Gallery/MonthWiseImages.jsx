...
function MonthWiseImages({ FormatedDate, EditButton = false }) {
  ...
  const DeleteImage = (path) => {
    var conf = "Are you sure it will delete your selected image!";
    ...
    if (window.confirm(conf)) {
      ...
      deleteObject(deleteRef)
        ...
        .catch((error) => {
          console.log(error);
          alert("image is not deleted! because the server is down.");
        });
    } else {
      setTimeout(() => {
        setShowModal(false);
      ...
      <Modal show={showModal} onHide={handleModalClose} centered>
        ...
        <Modal.Footer>
          ...
          <button
            ...
            style={{
              opacity:
                selectedImageIndex === getImagesFromFireBase.length - 1 && 0.2,
            }}
          >
            Next &#10095;
          </button>
